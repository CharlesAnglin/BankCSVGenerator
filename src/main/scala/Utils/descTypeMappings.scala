...
trait descTypeMappings {
  ...
  val descTypes = Map(
    ...
    Vector("GPS") ->
      Rent(),
    Vector("FROM ANGLIN" ,"CHARLES", "CLOSED ACCOUNT", "CHARLIE TESCO", "CHARLES REFERENCE INITIAL SUM", "ACCOUNT SAVING", "MR CHARLES DEVLIN ANGLIN REFERENCE", "INITIAL SUM", "REF. SANTANDER") ->
      Savings(),
